...
export declare function resolvePaymentMethodCode(typeOrCode: PaymentMethodType | PaymentMethodCode | string): PaymentMethodCode;
...
interface BaseCardPaymentRequest extends BasePaymentRequest {
    ...
    /**
     * @description 결제 통화입니다. 해외카드는 KRW, USD, JPY를 국내카드는 KRW만 지원합니다.
     */
    currency?: string;
