...
import { useState as B, useRef as z, useEffect as V, useMemo as Le } from "react";
import { u as ze, a as he, b as Ve, c as Fe, d as Ze, e as He, f as ge, g as Be, h as je, i as _e, j as Oe, k as We, l as ve, m as qe, n as $e, o as De, p as Ue, q as Ge, r as Qe, s as Ee, t as Xe, v as Ye } from "./hooks-C2Bp5v2q.mjs";
import { a as I, c as ee } from "./room-hCIn9AsS.mjs";
import { RoomEvent as Je, Track as S, ConnectionQuality as Q, RemoteTrackPublication as J, RemoteAudioTrack as Ke, ConnectionState as X } from "livekit-client";
import { ab as te, ac as pe, w as et, f as we, c as tt, ad as at, X as nt, Y as rt, a1 as $, l as j, ae as q, af as ct, i as _, B as lt, ag as ke, ah as ae, j as st, ai as it, m as ot, p as Re, aj as ut, ak as dt, al as mt, am as ft, an as ht } from "./contexts-B1pwZF2L.mjs";
const aa = /* @__PURE__ */ e.forwardRef(
  ...
  function({
    ...
    const f = et(), E = e.useRef("default"), p = e.useCallback(
      (w) => {
        f && f.emit(Je.MediaDevicesError, w), u == null || u(w);
      },
      [f, u]
    ), { devices: m, activeDeviceId: h, setActiveMediaDevice: y, className: C } = He({
      kind: n,
      room: f,
      track: l,
      requestPermissions: i,
    ...
    const A = async (w) => {
      ...
      () => I(d, { className: C }, { className: "lk-list" }),
      [C, d]
    ), v = !!m.find((w) => w.label.toLowerCase().startsWith("default"));
    function R(w, M, P) {
      return w === M || !v && P === 0 && M === "default";
    }
    return /* @__PURE__ */ e.createElement("ul", { ref: g, ...N }, m.map((w, M) => /* @__PURE__ */ e.createElement(
      "li",
      {
        key: w.deviceId,
        id: w.deviceId,
...
const fa = /* @__PURE__ */ e.forwardRef(function({ showIcon: n, ...a }, r) {
  ...
  const { className: r, quality: c } = _e(n), s = e.useMemo(() => ({ ...I(n, { className: r }), "data-lk-quality": c }), [c, n, r]);
...
function Ce(t, n = {}) {
  const [a, r] = e.useState(nt(t)), [c, s] = e.useState(a == null ? void 0 : a.isMuted), [o, l] = e.useState(a == null ? void 0 : a.isSubscribed), [i, u] = e.useState(a == null ? void 0 : a.track), [d, g] = e.useState("landscape"), f = e.useRef(), { className: E, trackObserver: p } = e.useMemo(() => rt(t), [
  ...
  return e.useEffect(() => {
    const m = p.subscribe((h) => {
      j.debug("update track", h), r(h), s(h == null ? void 0 : h.isMuted), l(h == null ? void 0 : h.isSubscribed), u(h == null ? void 0 : h.track);
    });
...
function Tt() {
  if (ue) return Y;
  ue = 1;
  var t = "Expected a function", n = NaN, a = "[object Symbol]", r = /^\s+|\s+$/g, c = /^[-+]0x[0-9a-f]+$/i, s = /^0b[01]+$/i, o = /^0o[0-7]+$/i, l = parseInt, i = typeof q == "object" && q && q.Object === Object && q, u = typeof self == "object" && self && self.Object === Object && self, d = i || u || Function("return this")(), g = Object.prototype, f = g.toString, E = Math.max, p = Math.min, m = function() {
    return d.Date.now();
  };
  function h(v, R, w) {
...
function zt(t, n, a) {
  const r = (u, d) => u === d, c = t instanceof Function ? t() : t, [s, o] = B(c), l = z(c), i = Lt(
    o,
    n,
    a
  );
...
function Vt({
  ...
  V(() => {
    var m;
    !l && ((m = u.entry) != null && m.target) && !r && !f && E.current !== u.entry.target && (E.current = u.entry.target, d({ isIntersecting: c, entry: void 0 }));
  }, [l, u.entry, r, f, c]);
  const p = [
    i,
    !!u.isIntersecting,
...
const Ft = /* @__PURE__ */ e.forwardRef(
  function({
    ...
    const m = (h) => {
      a == null || a(h), n == null || n({ participant: i == null ? void 0 : i.participant, track: E });
    };
...
const Bt = /* @__PURE__ */ e.forwardRef(
  function({
    ...
    const l = _(n), { elementProps: i } = ve({
      ...
      onParticipantClick: r,
      trackRef: l
    }), u = qe(l.participant), d = st(), g = (E = it()) == null ? void 0 : E.autoSubscription, f = e.useCallback(
      (m) => {
...
function Ea({ tracks: t, orientation: n, ...a }) {
  ...
  }, [f, i]), /* @__PURE__ */ e.createElement("aside", { key: i, className: "lk-carousel", ref: r, ...a }, /* @__PURE__ */ e.createElement(Ie, { tracks: E }, a.children));
}
function pa({
  value: t,
  onPinChange: n,
  ...
  function({ trackRef: n, ...a }, r) {
    ...
    return /* @__PURE__ */ e.createElement(
      ...
      /* @__PURE__ */ e.createElement(
        ...
        g.map((f, E) => /* @__PURE__ */ e.createElement(
          "rect",
          {
            key: E,
            x: E * 10,
...
const Dt = (t) => {
  ...
  function({ state: n, options: a, barCount: r = 15, trackRef: c, children: s, ...o }, l) {
    const i = I(o, { className: "lk-audio-bar-visualizer" });
    let u = te();
    c && (u = c);
    const d = Ee(u, {
      bands: r,
      loPass: 100,
      hiPass: 200
    }), g = (a == null ? void 0 : a.minHeight) ?? 20, f = (a == null ? void 0 : a.maxHeight) ?? 100, E = Ut(
      n,
      r,
      Qt(n, r) ?? 100
    );
...
const Sa = /* @__PURE__ */ e.forwardRef(
  function({ entry: n, hideName: a = !1, hideTimestamp: r = !1, messageFormatter: c, ...s }, o) {
    var f, E, p, m;
    const l = e.useMemo(() => c ? c(n.message) : n.message, [n.message, c]), i = !!n.editTimestamp, u = new Date(n.timestamp), d = typeof navigator < "u" ? navigator.language : "en-US", g = ((f = n.from) == null ? void 0 : f.name) ?? ((E = n.from) == null ? void 0 : E.identity);
    return /* @__PURE__ */ e.createElement(
      "li",
      {
        ref: o,
      ...
      /* @__PURE__ */ e.createElement("span", { className: "lk-message-attachements" }, (m = n.attachedFiles) == null ? void 0 : m.map(
        (h) => h.type.startsWith("image/") && /* @__PURE__ */ e.createElement(
          "img",
          {
...
//# sourceMappingURL=components-Bz2b1Fa9.mjs.map
